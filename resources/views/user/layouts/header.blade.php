                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="kitchen-renovation-calgary.html">kitchen Renovation Calgary</a></li>
                                        <li><a class="dropdown-item" href="kitchen-renovation-expert-in-edmonton.html">kitchen Renovation Edmonton</a></li>
                                        <li><a class="dropdown-item" href="kitchen-renovation-and-design-vancouver.html">kitchen Renovation Vancouver</a></li>
                                        <li><a class="dropdown-item" href="kitchen-design-and-renovation.html">kitchen Designer</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="flooring-installation-experts-in-calgary.html">Flooring Installation</a></li>
                                        <li><a class="dropdown-item" href="building-services-in-calgary.html">Building Permits</a></li>
                                        <li><a class="dropdown-item" href="basement-renovation-and-development-expert-in-calgary.html">Basement Renovations & development</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12">
                        <div class="desc">
                            <div class="brand-logo-wrapper">
                                <img class="brand-logo" src="./images/brand-logo.png" height="70" />
                            </div>
