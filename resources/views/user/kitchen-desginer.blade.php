...
@section('content')
<div class="relative-position-for--And-Renovation-Header ">
            <div class="Kitchen-Design-And-Renovation-Header">
                <div class="container">
                    ...
                    <div class="Kitchen-Design-And-Renovation-center">
                        ...
                        <div class="text-center ">
                            <h2 class="fs-70 fw-700"> <span class="text-white">Kitchen </span><span class="text-orange">
                                        Design &
                                        Renovation </span></h2>

                        </div>
                        <div class="text-center pt-3">
                            <p class="text-white fs-18 fw-300 ls-1 ws-1">Work With One of Our Kitchen Designers</p>
                        </div>
            ...
            <div class="header-background-section-for-kitchen-design-and-renovation"></div>
        ...
        <!-- Kitchen Design Consultancy section start -->

        <div class="container mt-3 ">
            <div class="text-center mb-5">

                <h1 class=" mb-3">Kitchen Design Consultancy</h1>
                <p class="text-center mb-4 ff-heading Kitchen-Design-Consultancy-heading6">Our Design Consutant would be happy to help you with your
                    project.</p>

                <div class="Kitchen-Design-Consultancy-content-background p-4 border-radius-20px">

                    <p class="Kitchen-Design-Consultancy-para m-0 py-0 px-3 fw-500 line-height-1-7">Our Kitchen Designer is a type of interior
                        designer who works with
                        clients to
                        discuss all aspects of
                        creating, remodeling, or updating the kitchen area of their home. You would discuss building
                        materials,
                        themes, colors, patterns, and room layout with a client. You'll then have to produce sketches
                        and drawings
                        based on what your client tells you he or she wants, which will serve as a basic plan for the
                        remodeling of
                        the kitchen. Once you start a project, you'll need to install lighting, flooring, appliances,
                        windows,
                        paint, drywall, doorways, counter tops, and other furnishings.</p>
            ...
            <div class="text-center mb-5">
                ...
                <h1 class=" mb-3">Customer Cabinetry</h1>
                <p class="text-center mb-4 ff-heading Kitchen-Design-Consultancy-heading6">We Manufacture Customer Cabinets in Our Manufacturing
                    Facilities.</p>

                <div class="Kitchen-Design-Consultancy-content-background p-4 border-radius-20px">

                    <p class="Kitchen-Design-Consultancy-para m-0 py-0 px-3 fw-500 line-height-1-7">At Kitchen Designer is a type of interior
                        designer who works with
                        clients to
                        discuss all aspects of
                        creating, remodeling, or updating the kitchen area of their home. You would discuss building
            ...
            <div class="text-center mb-3">
                ...
                <h1 class=" mb-3">Full-Service Kitchen Renovation</h1>
                <p class="text-center mb-4 Kitchen-Design-Consultancy-heading6 ff-heading">Our team does everything for design,
                    all the way to
                    kitchen
                    installation.</p>
        ...
        <!--  Kitchen Design Consultancy section end -->
                    ...
                    <div id="robotcarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <img src="{{asset('user/images/equipment.jpg')}}" height="380" class="border-radius-20px w-100 d-block"
                                    alt="swamp">
                            </div>
                            <div class="carousel-item ">

                                <img src="{{asset('user/images/Kitchen-Design-1.jpeg')}}" height="380"
                                    class="border-radius-20px w-100 d-block" alt="swamp">
                            </div>
                            <div class="carousel-item ">

                                <img src="{{asset('user/images/Kitchen-Design-2.jpeg')}}" height="380"
                                    class="border-radius-20px w-100 d-block" alt="swamp">
                            </div>
                        </div>
