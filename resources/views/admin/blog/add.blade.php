                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                                        name="description" required autocomplete="description" autofocus>{{ old('description') ?? ($data->description ?? '') }}</textarea>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="keywords" type="text"
                                        ...
                                        required autocomplete="keywords" class="form-control p-4"
                                        data-role="tagsinput" />
                                    @error('keywords')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="image" type="file"
                                        ...
                                        value="{{ old('image') ?? ($data->image ?? '') }}" required autocomplete="image"
                                        autofocus>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="summernote" type="text" class="form-control @error('keywords') is-invalid @enderror" name="body"
                                        required autocomplete="body" autofocus>{{ old('body') ?? ($data->body ?? '') }}</textarea>
