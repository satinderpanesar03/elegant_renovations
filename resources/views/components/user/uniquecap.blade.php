...
<div class="reflect-your-sense-of-style-section-wrapper">
    <div class="reflect-your-sense-of-style-section-heading">
        <h2>New Construction: Crafting Your Vision into Reality</h2>
        <div class="below-heading-line"></div>
    </div>
    <div class="reflect-your-sense-of-style-section-content">
        ...
        <div class="reflect-your-sense-of-style-section-content-desc col-md-12 col-lg-6">
            <div class="desc-1 desc-wrapper">
                ...
                <div>
                    <h5>Our Expertise</h5>
                    <p> Specializing in residential and commercial construction, we bring expertise in a wide range of projects, from custom homes to commercial spaces.</p>
                </div>
            </div>
            <div class="desc-2 desc-wrapper">
                <div><img src="{{asset('user/images/success-tick.png.png')}}" alt=""></div>
                <div>
                    ...
                    <p> We take pride in our commitment to delivering top-quality construction that meets and exceeds industry standards.</p>
                </div>
            </div>
            <div class="desc-3 desc-wrapper">
                <div><img src="{{asset('user/images/success-tick.png.png')}}" alt=""></div>
                <div>
                    ...
                    <p> We're committed to sustainable and eco-friendly building practices. Our projects are designed with the environment in mind.</p>
                </div>
            </div>
            <div class="desc-3 desc-wrapper">
                <div><img src="{{asset('user/images/success-tick.png.png')}}" alt=""></div>
                <div>
                    ...
                    <p> Our clients' satisfaction is our top priority. We work closely with you to understand your needs and ensure your vision becomes a reality.</p>
                </div>
            </div>
            <div class="desc-3 desc-wrapper">
                <div><img src="{{asset('user/images/success-tick.png.png')}}" alt=""></div>
                <div>
                    <h5>Safety First</h5>
                    <p> Safety is our utmost concern. We maintain rigorous safety standards to protect both our workers and your investment.</p>
                </div>
            </div>
            <div class="desc-btn-wrapper">
                <button >  <a href="{{route('user.contact.us')}}" class="text-decoration-none text-white"    >Get a Quote</a></button>
        ...
        <div class="reflect-your-sense-of-style-section-content-images col-md-12 col-lg-6">
            <div class="d-flex">
                <div class="Kitchen-Design-img-5 Kitchen-design-wrapper">
                </div>
                <div class="Kitchen-Design-img-6 Kitchen-design-wrapper">
                </div>
            </div>
            <div class="d-flex">
                <div class="Kitchen-Design-img-7 Kitchen-design-wrapper">
                </div>
                <div class="Kitchen-Design-img-8 Kitchen-design-wrapper">
                </div>
            </div>
        </div>
